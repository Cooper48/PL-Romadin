...
def clacked():
    if rad1.instate(['selected']) == True and rad2.instate(['selected']) == True and rad3.instate(['selected']) == True:
        messagebox.showinfo('Info', 'Вы выбрали все варианты.')
    elif rad1.instate(['selected']) == True and rad2.instate(['selected']) == True:
        messagebox.showinfo('Info', 'Вы выбрали варианты 1 и 2.')
    elif rad1.instate(['selected']) == True and rad3.instate(['selected']) == True:
        messagebox.showinfo('Info', 'Вы выбрали варианты 1 и 3.')
    elif rad2.instate(['selected']) == True and rad3.instate(['selected']) == True:
        messagebox.showinfo('Info', 'Вы выбрали варианты 2 и 3.')
    elif rad1.instate(['selected']) == True:
        messagebox.showinfo('Info', 'Вы выбрали вариант 1.')
    elif rad2.instate(['selected']) == True:
        messagebox.showinfo('Info', 'Вы выбрали вариант 2.')
    elif rad3.instate(['selected']) == True:
        messagebox.showinfo('Info', 'Вы выбрали вариант 3.')
    else:
        messagebox.showinfo('Info', 'Попробуйте снова')
#------------------------------------------------------------------
def clocked():
...
#------------------------------------------------------------------
window = Tk()
window.title("Ромадин Данил Алексеевич_УБ-23")
...
chk2 = BooleanVar()
chk3 = BooleanVar()
rad1 = Checkbutton(tab2, text='First',  var = chk1)
rad2 = Checkbutton(tab2, text='Second',  var = chk2)
rad3 = Checkbutton(tab2, text='Third',  var = chk3)
rad1.grid(column=0, row=0)
rad2.grid(column=1, row=0)
rad3.grid(column=2, row=0)
btn2 = Button(tab2, text = 'Select', command=clacked)
btn2.grid(column = '1', row = '2')
#------------------------------------------------------------------
menu = Menu(window)
item = Menu(menu, tearoff = 0)
item.add_command(label='Download file', command = clocked)
